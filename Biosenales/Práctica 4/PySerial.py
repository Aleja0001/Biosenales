...
numero_datos = 3000 # esto corresponde al numero de datos que se va adquirir, se puede modificar pero 1000 es un buen numero 
...
# fmt='%.4f' guarda los números con 4 decimales
np.savetxt("datos_emg3.txt", EMG, fmt='%.4f', header="Voltaje_EMG")

print("Datos guardados exitosamente en datos_emg.txt")
